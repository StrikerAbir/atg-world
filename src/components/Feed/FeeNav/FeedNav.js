...
const FeedNav = () => {
  ...
  return (
    <div>
      ...
      {/* for mobile */}
      <div className='d-flex justify-content-between align-items-center container d-md-none'>
        <p className='fw-bold m-0 mt-2'>Posts(368)</p>
        <button
          className="nav-link btn btn-light text-black dropdown-toggle px-3 py-1 mt-3"
          data-bs-toggle="dropdown"
          href="/"
          aria-expanded="false"
        >
          <span className="pe-2">Filter: All</span>
        </button>
      </div>
    </div>
  );
